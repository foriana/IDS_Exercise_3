...
garden_harvest %>%
  ...
  pivot_wider(id_cols =day_of_week:weight_lb,
              names_from = day_of_week,
              values_from = weight_lb)
...
```
  ...
  __Finding average harvest, Price with tax__
...
garden_harvest %>% 
  ...
  pivot_wider(id_cols = vegetable:letter_num,
              names_from = lower_variety, 
              values_from = letter_num)
